...
{
	battery_log(BAT_LOG_CRTI, "[BATTERY] select_charging_curret_bcct g_bcct_value : %d\r\n",
						g_bcct_value);
	battery_log(BAT_LOG_CRTI, "[BATTERY] select_charging_curret_bcct BMT_status.charger_type : %d\r\n",
...
static void pchr_turn_on_charging(void)
{
	...
	battery_log(BAT_LOG_CRTI, "[BATTERY] msleep(150) begin, delay 150ms to enable charging, enable =%d !\r\n",
			    charging_enable);
	msleep(150);//delay 150ms to enable charging
	battery_log(BAT_LOG_CRTI, "[BATTERY] msleep(150) end, delay 150ms to enable charging, enable =%d !\r\n",
			    charging_enable);
