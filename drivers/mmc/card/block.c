...
//lixiongwei@yulong.com 2015.9.11 mtk patch 117
	/*
...
#endif
/*----added by chenlifeng@yulong.com for yl-params & yl-panic,2015.04.01-----*/
	if (strcmp(md->disk->disk_name, "mmcblk0")==0)
	  {
	   }
/*----ended by chenlifeng@yulong.com for yl-params & yl-panic,2015.04.01-----*/
	if (mmc_add_disk(md))
		goto out;
