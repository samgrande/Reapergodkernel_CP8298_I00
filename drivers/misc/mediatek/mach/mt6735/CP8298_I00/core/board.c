...
#define MSDC_SDIO_FLAG    (MSDC_EXT_SDIO_IRQ | MSDC_HIGHSPEED | MSDC_UHS1)
    ...
    struct msdc_ett_settings msdc0_ett_settings[] = {
        ...
        { MSDC_HS400_MODE, 0x188, (0x1f<<12), 0x10 /*0x13*/}, //EMMC50_PAD_DS_TUNE[MSDC_EMMC50_PAD_DS_TUNE_DLY3]
    ...
    struct msdc_hw msdc1_hw = {
        ...
        .rdata_edge           = MSDC_SMPL_FALLING,
        .wdata_edge           = MSDC_SMPL_FALLING,
        .clk_drv              = 7,//liyongfeng@yulong.com modify for SD card driving 2015-06-09
        .cmd_drv              = 3,
        .dat_drv              = 3,
        .clk_drv_sd_18        = 5,         /* sdr104 mode *///liyongfeng@yulong.com modify for SD card driving 2015-06-09
        .cmd_drv_sd_18        = 2,
        .dat_drv_sd_18        = 2,
        .clk_drv_sd_18_sdr50	= 5,         /* sdr50 mode *///liyongfeng@yulong.com modify for SD card driving 2015-06-09
        .cmd_drv_sd_18_sdr50	= 2,
        .dat_drv_sd_18_sdr50	= 2,
        .clk_drv_sd_18_ddr50	= 5,         /* ddr50 mode *///liyongfeng@yulong.com modify for SD card driving 2015-06-09
        .cmd_drv_sd_18_ddr50	= 2,
        .dat_drv_sd_18_ddr50	= 2,
        .data_pins            = 4,
        .data_offset          = 0,
    #ifdef CUST_EINT_MSDC1_INS_NUM
        .flags                = MSDC_SYS_SUSPEND | MSDC_CD_PIN_EN | MSDC_REMOVABLE | MSDC_HIGHSPEED | MSDC_UHS1 , //remove MSDC_DDR flag by fanli to reduce clk frequency to compatible T-card in 20150713
    #else
        .flags                = MSDC_SYS_SUSPEND | MSDC_HIGHSPEED | MSDC_UHS1 , //remove MSDC_DDR flag by fanli to reduce clk frequency to compatible T-card in 20150713
    #endif
        .dat0rddly            = 0,
        .dat1rddly            = 0,
        .dat2rddly            = 0,
...
#elif defined(CONFIG_MTK_C2K_SUPPORT)
