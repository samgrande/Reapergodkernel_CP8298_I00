...
{
	int i = 0;
    //modify for Patch ALPS02093284 by xuzhixian@yulong.com 20150528 start
    ...
    // do reset
    //modify for Patch ALPS02093284 by xuzhixian@yulong.com 20150528 end
	for(i = DSI_MODULE_BEGIN(module);i <= DSI_MODULE_END(module);i++)
	{
...
{	
	...
	for(i = DSI_MODULE_BEGIN(module);i <= DSI_MODULE_END(module);i++)
	{
        ...
        DSI_OUTREG32(cmdq,&DSI_REG[i]->DSI_TXRX_CTRL, AS_UINT32(&regs->DSI_TXRX_CTRL) & 0xFFFFFFC3); //modify for Patch ALPS02093284 by xuzhixian@yulong.com 20150528
...
DSI_STATUS DSI_TXRX_Control(DISP_MODULE_ENUM module, cmdqRecHandle cmdq, LCM_DSI_PARAMS *dsi_params)
{
    ...
    bool hstx_cklp_en = TRUE; //modify for non continue clock by xuzhixian@yulong.com 20150508
...
int ddp_dsi_init(DISP_MODULE_ENUM module, cmdqRecHandle cmdq)
{
...
#endif
	{
        ...
        // DSI_OUTREGBIT(NULL, DSI_INT_ENABLE_REG,DSI_REG[0]->DSI_INTEN,TE_RDY,1);//modify for Patch ALPS02093284 by xuzhixian@yulong.com 20150528
...
int ddp_dsi_power_off(DISP_MODULE_ENUM module, void *cmdq_handle)
{
	int i = 0;
	int ret = 0;
    unsigned int value = 0; //modify for Patch ALPS02093284 by xuzhixian@yulong.com 20150528
	DISPFUNC();
	//DSI_DumpRegisters(module,1);
