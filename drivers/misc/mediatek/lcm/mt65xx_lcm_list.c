...
/*** add for CP8681 by gongrui@yulong.com 20150518 start ***/
#if defined(NT35596_YS_AUO_5P5_VDO_FHD_8681)
extern LCM_DRIVER nt35596_dsi_vdo_yassy_auo_lcm_drv;
#endif

#if defined(NT35596_BY_LG_5P5_VDO_FHD_8681)
extern LCM_DRIVER nt35596_dsi_vdo_by_lg_lcm_drv;
#endif

#if defined(OTM1901A_TIANMA_TM_5P5_VDO_FHD_8681)
extern LCM_DRIVER otm1901a_dsi_vdo_tianma_tm_lcm_drv;
#endif

#if defined(OTM1901A_LIDE_LG_5P5_VDO_FHD_8681)
extern LCM_DRIVER otm1901a_dsi_vdo_lide_lg_lcm_drv;
#endif

#if defined(NT35596_BY_AUO_5P5_VDO_FHD_8681)
extern LCM_DRIVER nt35596_dsi_vdo_by_auo_lcm_drv;
#endif
/*** add for CP8681 by gongrui@yulong.com 20150518 end ***/
/*** add for Y71 by xuzhixian@yulong.com 20150710 start ***/
#if defined(HX8389C_YS_CPT_5P0_VDO_QHD_Y71)
extern LCM_DRIVER hx8389c_dsi_ys_cpt_lcm_drv;
#endif

#if defined(OTM9605_BY_LG_5P0_VDO_QHD_Y71)
extern LCM_DRIVER otm9605_dsi_by_lg_lcm_drv;
#endif
/*** add for Y71 by xuzhixian@yulong.com 20150710 end ***/

/*** add for 8298-A01 by xuzhixian@yulong.com 20150320 start ***/
#if defined(OTM1285A_TM_TM_5P0_VDO_HD_8298)
extern LCM_DRIVER otm1285a_dsi_tm_tm_lcm_drv;
#endif

#if defined(R61318_OF_LG_5P0_VDO_HD_8298)
extern LCM_DRIVER r61318_dsi_of_lg_lcm_drv;
#endif

#if defined(ILI9881C_YS_CPT_ID21_5P0_VDO_HD_8298)
extern LCM_DRIVER ili9881c_dsi_ys_cpt_id21_lcm_drv;
#endif

#if defined(ILI9881C_YS_CPT_ID41_5P0_VDO_HD_8298)
extern LCM_DRIVER ili9881c_dsi_ys_cpt_id41_lcm_drv;
#endif

#if defined(R61318_DJ_LG_5P0_VDO_HD_8298)
extern LCM_DRIVER r61318_dsi_dj_lg_lcm_drv;
#endif

#if defined(ILI9881C_YS_CPT_5P0_VDO_HD_8298)
extern LCM_DRIVER ili9881c_dsi_ys_cpt_lcm_drv;
#endif
#if defined(OTM1287A_OF_INNO_5P0_VDO_HD_8298)
extern LCM_DRIVER otm1287a_dsi_of_inno_lcm_drv;
#endif
/*** add for 8298-A01 by xuzhixian@yulong.com 20150320 end ***/
//start 2015.05.18 lijianbin@yulong.com add by lijianbin for 8676-a01
#if defined(OTM1284A_BY_CPT_5P5_VDO_HD_8676)
extern LCM_DRIVER otm1284a_dsi_vdo_by_cpt_lcm_drv;
#endif

#if defined(OTM1284A_TM_TM_5P5_VDO_HD_8676)
extern LCM_DRIVER otm1284a_dsi_vdo_tm_tm_lcm_drv;
#endif

#if defined(ILI9881_YS_CPT_5P5_VDO_HD_8676)
extern LCM_DRIVER ili9881_dsi_vdo_ys_cpt_lcm_drv;
#endif

#if defined(R61318_LD_LG_5P5_VDO_HD_8676)
extern LCM_DRIVER r61318_dsi_vdo_ld_lg_lcm_drv;
#endif
//end 2015.05.18 lijianbin@yulong.com add by lijianbin for 8676-a01

LCM_DRIVER* lcm_driver_list[] =
{
/*** add for CP8681 by gongrui@yulong.com 20150518 start ***/
#if defined(NT35596_YS_AUO_5P5_VDO_FHD_8681)
   &nt35596_dsi_vdo_yassy_auo_lcm_drv,
#endif

#if defined(OTM1901A_TIANMA_TM_5P5_VDO_FHD_8681)
   &otm1901a_dsi_vdo_tianma_tm_lcm_drv,
#endif

#if defined(OTM1901A_LIDE_LG_5P5_VDO_FHD_8681)
    &otm1901a_dsi_vdo_lide_lg_lcm_drv,
#endif

#if defined(NT35596_BY_AUO_5P5_VDO_FHD_8681)
    &nt35596_dsi_vdo_by_auo_lcm_drv,
#endif

#if defined(NT35596_BY_LG_5P5_VDO_FHD_8681)
    &nt35596_dsi_vdo_by_lg_lcm_drv,
#endif
/*** add for CP8681 by gongrui@yulong.com 20150518 end ***/
/*** add for Y71 by xuzhixian@yulong.com 20150710 start ***/
#if defined(HX8389C_YS_CPT_5P0_VDO_QHD_Y71)
    &hx8389c_dsi_ys_cpt_lcm_drv,
#endif

#if defined(OTM9605_BY_LG_5P0_VDO_QHD_Y71)
    &otm9605_dsi_by_lg_lcm_drv,
#endif
/*** add for Y71 by xuzhixian@yulong.com 20150710 start ***/

/*** add for 8298-A01 by xuzhixian@yulong.com 20150320 start ***/
#if defined(OTM1285A_TM_TM_5P0_VDO_HD_8298)
    &otm1285a_dsi_tm_tm_lcm_drv,
#endif

#if defined(R61318_OF_LG_5P0_VDO_HD_8298)
    &r61318_dsi_of_lg_lcm_drv,
#endif

#if defined(ILI9881C_YS_CPT_ID21_5P0_VDO_HD_8298)
    &ili9881c_dsi_ys_cpt_id21_lcm_drv,
#endif

#if defined(ILI9881C_YS_CPT_ID41_5P0_VDO_HD_8298)
    &ili9881c_dsi_ys_cpt_id41_lcm_drv,
#endif

#if defined(R61318_DJ_LG_5P0_VDO_HD_8298)
    &r61318_dsi_dj_lg_lcm_drv,
#endif

#if defined(ILI9881C_YS_CPT_5P0_VDO_HD_8298)
    &ili9881c_dsi_ys_cpt_lcm_drv,
#endif
#if defined(OTM1287A_OF_INNO_5P0_VDO_HD_8298)
    &otm1287a_dsi_of_inno_lcm_drv,
#endif
/*** add for 8298-A01 by xuzhixian@yulong.com 20150320 end ***/
...
#if defined(ILI9881_YS_CPT_5P5_VDO_HD_8676)
    &ili9881_dsi_vdo_ys_cpt_lcm_drv,
#endif

#if defined(OTM1284A_TM_TM_5P5_VDO_HD_8676)
    &otm1284a_dsi_vdo_tm_tm_lcm_drv,
#endif
